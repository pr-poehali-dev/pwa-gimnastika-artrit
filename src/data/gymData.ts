...
export const EXERCISES: Exercise[] = [
  ...
  { zoneId: 'fingers_hand_left', zoneName: 'Пальцы левой руки', mode: 'normal', name: 'Веер', description: 'Медленно раскрывайте и закрывайте пальцы левой руки как веер', reps: '10 повторений' },
  { zoneId: 'fingers_hand_right', zoneName: 'Пальцы правой руки', mode: 'normal', name: 'Веер', description: 'Медленно раскрывайте и закрывайте пальцы правой руки как веер', reps: '10 повторений' },
  ...
  { zoneId: 'fingers_foot_left', zoneName: 'Пальцы левой ноги', mode: 'normal', name: 'Сжатие-разжатие', description: 'Медленно сжимайте и разжимайте пальцы левой ноги', reps: '10 повторений' },
  { zoneId: 'fingers_foot_right', zoneName: 'Пальцы правой ноги', mode: 'normal', name: 'Сжатие-разжатие', description: 'Медленно сжимайте и разжимайте пальцы правой ноги', reps: '10 повторений' },
  ...
  { zoneId: 'fingers_hand_left', zoneName: 'Пальцы левой руки', mode: 'micro', name: 'Микровеер', description: 'Слегка раздвигайте пальцы левой руки на 1-2 мм', reps: '10 повторений' },
  { zoneId: 'fingers_hand_right', zoneName: 'Пальцы правой руки', mode: 'micro', name: 'Микровеер', description: 'Слегка раздвигайте пальцы правой руки на 1-2 мм', reps: '10 повторений' },
  ...
  { zoneId: 'fingers_foot_left', zoneName: 'Пальцы левой ноги', mode: 'micro', name: 'Микросжатие', description: 'Едва заметное сжатие пальцев левой стопы', reps: '10 повторений' },
  { zoneId: 'fingers_foot_right', zoneName: 'Пальцы правой ноги', mode: 'micro', name: 'Микросжатие', description: 'Едва заметное сжатие пальцев правой стопы', reps: '10 повторений' },
  ...
  { zoneId: 'fingers_hand_left', zoneName: 'Пальцы левой руки', mode: 'vibro', name: 'Напряжение без движения', description: 'Как будто хотите сжать левый кулак, но не сжимаете', reps: '10 повторений' },
  { zoneId: 'fingers_hand_right', zoneName: 'Пальцы правой руки', mode: 'vibro', name: 'Напряжение без движения', description: 'Как будто хотите сжать правый кулак, но не сжимаете', reps: '10 повторений' },
  ...
  { zoneId: 'fingers_foot_left', zoneName: 'Пальцы левой ноги', mode: 'vibro', name: 'Напряжение стопы', description: 'Напрягите левую стопу, пальцы неподвижны', reps: '10 повторений' },
  { zoneId: 'fingers_foot_right', zoneName: 'Пальцы правой ноги', mode: 'vibro', name: 'Напряжение стопы', description: 'Напрягите правую стопу, пальцы неподвижны', reps: '10 повторений' },
